...
* You can use the shortcode *[pretty_gist id="**gist_id**"]* to embed the pretty gist directly into a post
* You have the option to change the default colors in Settings > Pretty Gists
